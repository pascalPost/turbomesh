...
fn uniform_clustering(n: Index) -> ndarray::Array1<Scalar> {
    ndarray::Array::linspace(0.0, 1.0, n)
}

fn single_exponential_clustering(n: Index, A: Scalar) -> ndarray::Array1<Scalar> {
...
fn roberts_clustering(n: Index, alpha: Scalar, beta: Scalar) -> ndarray::Array1<Scalar> {
    let x = ndarray::Array::linspace(0.0, 1.0, n);
    x.mapv_into(|v| {
...
fn uniform_distribution(start: Scalar, end: Scalar, n: Index) -> ndarray::Array1<Scalar> {
