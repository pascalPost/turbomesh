...
const InitFn = *const fn (*const std.mem.Allocator) callconv(.c) ?*anyopaque;
...
pub const Lib = struct {
    ...
    // pub fn init(self: Lib, allocator: *const std.mem.Allocator) ?*anyopaque {
    //     return self.init_fn(allocator);
    // }
    //
